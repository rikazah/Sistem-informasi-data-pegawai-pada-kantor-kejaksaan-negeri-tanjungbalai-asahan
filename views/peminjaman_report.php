        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="fa fa-user-plus"></span> Laporan Data Pegawai Kejaksaan Negeri Tanjung Balai-Asahan</h3>
                </div>
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>Nama</th><th width="17%">Nama Pegawai</th><th>Nip</th><th>Jabatan</th><th>Bidang</th>
                            </tr>
                        </thead>
                        <tbody>
